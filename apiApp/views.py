...
def delete_review(request, pk):
    ...
    return Response("Review deleted succesfully!", status=204)
...
def delete_cartitem(request, pk):
    ...
    return Response("Cartitem deleted succesfully!", status=204)
...
def add_to_wishlist(request):
    ...
    if wishlist:
        wishlist.delete()
        return Response("Wishlist deleted succesfully!", status=204)
...
def product_search(request):
    ...
    if not query:
        return Response("No query providerd", status=400)
